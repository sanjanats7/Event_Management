...
urlpatterns = [
    ...
    path('assignments/', AssignmentAPI.as_view(), name='assignment_list'),  # Add this line
    path('assignments/<int:pk>/',AssignmentAPI.as_view(), name='assignment_detail'),  # Add this line
